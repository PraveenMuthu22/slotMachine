...
var allReelsStopped: boolean = true;
var maxButtonPressed: boolean = false;


var reel1: Reel = new Reel();
var reel2: Reel = new Reel();
var reel3: Reel = new Reel();
...
var backgroundMusic: HTMLAudioElement = <HTMLAudioElement>document.getElementById("backgroundMusic");
...
function startThread(imgId: string, reel: Reel) {
...
function stopSpinning(thread, reel: Reel) {
    ...
    //if reel is not spinning say so
    else {
...
function uploadScore() {
    var nameTxt: HTMLInputElement = <HTMLInputElement>document.getElementById("nameTxt");
